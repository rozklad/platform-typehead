...
return [
	...
	*/
	...
	'providers' => [
		'Sanatorium\Typehead\Providers\TypeheadServiceProvider'
	],
	...
	*/
	...
	'routes' => function(ExtensionInterface $extension, Application $app)
	{
		Route::group([
			'prefix'    => 'typehead',
			'namespace' => 'Sanatorium\Typehead\Controllers\Frontend',
		], function()
		{
			Route::get('products', ['as' => 'sanatorium.typehead.products', 'uses' => 'TypeheadController@products']);
			Route::get('productsLive', ['as' => 'sanatorium.typehead.products.live', 'uses' => 'TypeheadController@productsLive']);
		});
	},
	...
	*/
	...
	'menus' => [
		...
		'admin' => [
			...
			/*[
				'slug'  => 'admin-sanatorium-typehead',
				'name'  => 'Typehead',
				'class' => 'fa fa-circle-o',
				'uri'   => 'typehead',
				'regex' => '/:admin\/typehead/i',
			],*/
